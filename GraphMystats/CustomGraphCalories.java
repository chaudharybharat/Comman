...
public class CustomGraphCalories extends SeekBar implements View.OnTouchListener,View.OnClickListener {
    ...
    public CustomGraphCalories(Context context) {
        super(context);
        //   mSeekBar_data = new ArrayList<ProgressItem>();
        mColorList = new ArrayList<Integer>();
    }

    public CustomGraphCalories(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomGraphCalories(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        layout_widh = getResources().getDimensionPixelSize(R.dimen.dp_40);
      ...
      /*  if (mSeekBar_data.size() > 0) {*/
        ...
        canvas.drawText("5000+", 0, 5, progressItemRight - layout_widh, 100, paint_txt_normal);
        ...
        for (int j = 0; j < mSeekBar_data.size(); j++) {
            ...
            if(mSeekBar_data.get(j).getValue()>=500) {
                ...
                if (mSeekBar_data.get(j).getValue() >= 500) {
                    ...
                    //change ony this
                    Log.e("test", "====>>" + value);
                    float x_point = value * totla_with_data / 4500;
