 ...
 */
public class SplashScreen1 extends BaseFragment {


    @BindView(R.id.sv_spalce)
    SimpleDraweeView sv_spalce;
    public static String KEY_IMAG="key";
    public static SplashScreen1 getInstance(String imge){
        SplashScreen1 splaceScreen1=new SplashScreen1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_splace_screen1, container, false);
    }
    @Override
