 ...
 */
public class SplashScreen2 extends BaseFragment {

    @BindView(R.id.sv_spalce)
    SimpleDraweeView sv_spalce;
    public static String KEY_IMAG = "key";

    public static SplashScreen2 getInstance(String imge) {
        SplashScreen2 splaceScreen1 = new SplashScreen2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_splace_screen2, container, false);
    }
